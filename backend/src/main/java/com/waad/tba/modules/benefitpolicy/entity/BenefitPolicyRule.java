...
public class BenefitPolicyRule {
    ...
    public boolean appliesTo(MedicalService service) {
        ...
        if (medicalCategory != null && service.getCategoryEntity() != null) {
            return medicalCategory.getId().equals(service.getCategoryEntity().getId());
        }
    ...
    public String getLabel() {
        if (medicalService != null) {
            return "Service: " + medicalService.getNameAr();
        }
        if (medicalCategory != null) {
            return "Category: " + medicalCategory.getNameAr();
        }
        return "Rule #" + id;
    }
