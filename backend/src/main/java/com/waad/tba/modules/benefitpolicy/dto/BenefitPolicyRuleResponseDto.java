        ...
        if (rule.isCategoryRule()) {
            ...
            if (rule.getMedicalCategory() != null) {
                builder.medicalCategoryId(rule.getMedicalCategory().getId())
                       ...
                       .medicalCategoryNameAr(rule.getMedicalCategory().getNameAr())
                       .medicalCategoryNameEn(rule.getMedicalCategory().getNameEn());
            }
            ...
            if (rule.getMedicalService() != null) {
                ...
                // Also include category info for context
                if (rule.getMedicalService().getCategoryEntity() != null) {
                    builder.medicalCategoryId(rule.getMedicalService().getCategoryEntity().getId())
                           .medicalCategoryCode(rule.getMedicalService().getCategoryEntity().getCode())
                           .medicalCategoryNameAr(rule.getMedicalService().getCategoryEntity().getNameAr())
                           .medicalCategoryNameEn(rule.getMedicalService().getCategoryEntity().getNameEn());
                }
            }
        }
