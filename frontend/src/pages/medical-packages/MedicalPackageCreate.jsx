...
/**
 * Medical Package Create Page
 * Form to create a new medical package with services selection
 */
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={6}>
              <TextField
                ...
                placeholder="Comprehensive Checkup Package"
              />
            </Grid>
