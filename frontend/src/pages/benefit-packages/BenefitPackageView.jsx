    ...
    <>
      ...
      <MainCard>
        <Grid container spacing={3}>
          ...
          <Grid item xs={12}>
            {pkg.medicalPackages && pkg.medicalPackages.length > 0 ? (
                    ...
                    {pkg.medicalPackages.map((medicalPkg) => (
                      <TableRow key={medicalPkg.id}>
                        ...
                        <TableCell align="right">
                          {medicalPkg.priceLyd ? `${medicalPkg.priceLyd.toFixed(2)}` : '-'}
                        </TableCell>
                        <TableCell align="center">
                          <Chip
          ...
          <Grid item xs={12} md={6}>
            <Paper variant="outlined" sx={{ p: 2 }}>
              ...
              <Typography variant="body1">{pkg.createdAt ? new Date(pkg.createdAt).toLocaleString('ar-LY') : '-'}</Typography>
            </Paper>
          </Grid>
          ...
          <Grid item xs={12} md={6}>
            <Paper variant="outlined" sx={{ p: 2 }}>
              ...
              <Typography variant="body1">{pkg.updatedAt ? new Date(pkg.updatedAt).toLocaleString('ar-LY') : '-'}</Typography>
            </Paper>
          </Grid>
